/*
 * Admin Tailwind teması — React projesindeki admin/src/styles/tailwind.css karşılığı.
 * Bu script, Tailwind tarayıcı derleyicisinden (CDN) ÖNCE yüklenmelidir.
 */
(function () {
  'use strict';
  ...
  var css = [
    ...
    '  --color-on-tertiary-container: #ef9900;',
    ...
    '  --color-tertiary-container: #5c3800;',
    ...
    '',
    '  --shadow-card: 0 4px 20px rgba(30, 58, 138, 0.05);',
    '}',
    '',
    '@layer base {',
    '  html,',
