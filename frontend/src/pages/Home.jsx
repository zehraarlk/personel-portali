            ...
            >
              ...
              >
                {[...duyurular, ...duyurular].map((d, index) => (
                  <div
                    key={`${d.id}-${index}`}
                    className="flex flex-col shrink-0 w-24 rounded-xl bg-white/10 hover:bg-white/20 border border-white/15 p-1.5 transition cursor-pointer"
                  >
                    ...
                    <span className="mt-1.5 whitespace-normal line-clamp-2 text-[11px] font-semibold leading-snug text-white/95">
                      {d.baslik}
                    </span>
                  </div>
                ))}
